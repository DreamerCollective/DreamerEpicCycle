...
#include "source/raptor/application/window.hpp"
#include "source/raptor/application/input.hpp"
#include "source/raptor/application/keys.hpp"
#include "source/raptor/application/game_camera.hpp"

#include "source/graphics/gpu_device.hpp"
#include "source/graphics/command_buffer.hpp"
#include "source/graphics/spirv_parser.hpp"
#include "source/graphics/gpu_profiler.hpp"
#include "source/graphics/raptor_imgui.hpp"
#include "source/graphics/renderer.hpp"
#include "source/graphics/render_scene.hpp"
#include "source/graphics/gltf_scene.hpp"
#include "source/graphics/obj_scene.hpp"
#include "source/graphics/frame_graph.hpp"
#include "source/graphics/asynchronous_loader.hpp"
#include "source/graphics/scene_graph.hpp"
#include "source/graphics/render_resources_loader.hpp"

#include "source/external/cglm/struct/vec2.h"
#include "source/external/cglm/struct/mat2.h"
#include "source/external/cglm/struct/mat3.h"
#include "source/external/cglm/struct/mat4.h"
#include "source/external/cglm/struct/cam.h"
#include "source/external/cglm/struct/affine.h"
#include "source/external/cglm/struct/box.h"
#include "source/external/enkiTS/TaskScheduler.h"
#include "source/external/json.hpp"

#include "source/raptor/foundation/file.hpp"
#include "source/raptor/foundation/numerics.hpp"
#include "source/raptor/foundation/time.hpp"
#include "source/raptor/foundation/resource_manager.hpp"

#include "source/external/imgui/imgui.h"
#include "source/external/stb_image.h"
#include "source/external/tracy/tracy/Tracy.hpp"

#include <stdio.h>
#include <stdlib.h>
 
#include "source/external/flecs/flecs/flecs.h"
#include "source/interaction/Items/ItemModule.h"
            ...
            for (u32 y = 0; y < tile_y_count; ++y) {
                for (u32 x = 0; x < tile_x_count; ++x) {
                    ...
                    for (u32 l = 0; l < scene->active_lights; ++l) {
                        ...
                        f32 minx = std::min(raptor::min(light_aabb_min.x, light_aabb_max.x), raptor::min(min_point_aabb_view.x, max_point_aabb_view.x));
                        f32 miny = std::min(raptor::min(light_aabb_min.y, light_aabb_max.y), raptor::min(min_point_aabb_view.y, max_point_aabb_view.y));
                        f32 minz = std::min(raptor::min(light_aabb_min.z, light_aabb_max.z), raptor::min(min_point_aabb_view.z, max_point_aabb_view.z));

                        f32 maxx = std::max(raptor::max(light_aabb_min.x, light_aabb_max.x), raptor::max(min_point_aabb_view.x, max_point_aabb_view.x));
                        f32 maxy = std::max(raptor::max(light_aabb_min.y, light_aabb_max.y), raptor::max(min_point_aabb_view.y, max_point_aabb_view.y));
                        f32 maxz = std::max(raptor::max(light_aabb_min.z, light_aabb_max.z), raptor::max(min_point_aabb_view.z, max_point_aabb_view.z));
...
int main(int argc, char** argv) {
    ...
    if (argc < 2) {
        printf("Usage: DreamerEpicCycle [path to glTF model]\n");
