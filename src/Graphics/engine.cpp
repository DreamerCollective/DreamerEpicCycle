/*
 *  Copyright 2023 Dreamer Collective
 *
...
#include "../../DiligentEngine/DiligentCore/Platforms/Win32/interface/Win32NativeWindow.h"
...
// fragment (pixel) shader simply outputs interpolated vertex color
...
#    endif
    ...
    void CreateResources()
    {
        ...
        RefCntAutoPtr<IShader> pPS;
        {
            ...
            ShaderCI.EntryPoint      = "main";
            ShaderCI.Desc.Name       = "Triangle fragment (pixel) shader";
...
std::unique_ptr<DreamerEngine> g_pTheApp;
                   ...
                   _In_ int           nShowCmd)
{
    ...
    g_pTheApp.reset(new DreamerEngine);
